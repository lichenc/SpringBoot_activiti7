...
var notice = function (message, title, buttonCapture) {
    ...
    message == null ? message = "nulll" : message, title == null ? title = "" : title, buttonCapture == null ? buttonCapture = "确定" : buttonCapture;
    ...
    document.getElementById("noticePopup").style.display = "-webkit-flex"
};
var confirms = function (message, title,textleft,textright) {
    ...
    message == null ? message = "nulll" : message, title == null ? title = "" : title;
    var popupBackdrop = document.createElement("div");
    popupBackdrop.setAttribute("class", "popup-backdrop fadeIn");
    popupBackdrop.setAttribute("id", "popup-backdrop");
    popupBackdrop.setAttribute("style", "display: none;");
...
var confirmsadd = function (message, title,ensure,cancel) {
    var isDom = document.getElementById("confirmPopup");
    if (isDom) {
        document.body.removeChild(isDom)
    }
    ...
    confirmPopup.setAttribute("class", "own-popup");
    confirmPopup.setAttribute("style", "display: none;");
    var appendDom = '<div id="popup-in" class="animated pulse"><div class="popup-inner"><div class="popup-title">' + title + '</div><div class="popup-text">' + message + '</div></div><div class="popup-buttons"><span class="popup-button" id="confirmY" onclick=isConfirm_confirm(); ontouchstart=btn_touchstart(this); ontouchend=btn_ontouchend(this);>'+ensure+'</span><span class="popup-button popup-button-bold" style="border-left: 1px #CCC solid;" id="confirmX" onclick=isConfirm_confirm(); ontouchstart=btn_touchstart(this); ontouchend=btn_ontouchend(this);>'+cancel+'</span></div></div>';
    confirmPopup.innerHTML = appendDom;
    document.body.appendChild(popupBackdrop);
    document.body.appendChild(confirmPopup);
    document.getElementById("popup-backdrop").style.display = "block";
...
var prompts = function (message, title, tip) {
    ...
    message == null ? message = "nulll" : message, title == null ? title = "" : title, tip == null ? tip = "" : tip;
    var popupBackdrop = document.createElement("div");
    popupBackdrop.setAttribute("class", "popup-backdrop fadeIn");
    popupBackdrop.setAttribute("id", "popup-backdrop");
    popupBackdrop.setAttribute("style", "display: none;");
    ...
    document.getElementById("popup-backdrop").style.display = "block";
    document.getElementById("dialoguePopup").style.display = "-webkit-flex"
};
